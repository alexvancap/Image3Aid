...
const questionsAndAnswers = [
  ...
  {id: 3, question: 'What exactly is this fundraiser?', answer: 'We are launching a collection of images from 50+ photographers from the NFT community. Each image will be available in an edition of 50, and the minting will be randomized.'},
  {id: 4, question: 'How much will it be to mint?', answer: 'Mint price will be .05 ETH.'},
